...
description: Introduction the NextJs Founder Boilerplate (Typescript)
updatedAt: 2023-10-24
---

This is a Next.js boilerplate that enables you to quickly launch your next project with subscription / one-time payments.
